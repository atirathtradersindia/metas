...
import freightData from '../data/oceanfreight.json';
...
const SeaFreight = () => {
    ...
    return (
        <div className="sea-freight-container">
            <h1 className="sea-freight-heading">Sea Freight Costs</h1>
            ...
            <div className="dropdown-container">
                ...
                <div className="dropdown">
                    ...
                    >
                        <span>{selectedRegion ? selectedRegion : 'Select Region'}</span>
            ...
            <div className="ports-container">
                <div className="country-content">
                    <h3 className="country-heading">Ports</h3>
                    {selectedCountry ? (
                        ...
                        <div className="port-placeholder">
                            Select a country to view ports
                        </div>
                    )}
                </div>
            </div>
